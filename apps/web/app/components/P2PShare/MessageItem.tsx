...
export default function MessageItem({ msg, isSmallScreen }: MessageItemProps) {
  ...
  return (
    ...
    >
      <div className='text-xs text-slate-500 mb-1 font-semibold px-2'>
      ...
      {msg.type === 'text' ? (
        ...
        >
          <div className='flex items-center gap-3'>
            <div className='w-11 h-11 rounded-xl bg-cyan-50 flex items-center justify-center border border-cyan-200/60 text-cyan-700 flex-shrink-0'>
              <svg
                className='w-5 h-5'
                fill='none'
                stroke='currentColor'
